...
/***/ (function(module, exports, __webpack_require__) {
	...
	var ArtifactoryCookies = __webpack_require__(141).ArtifactoryCookies;

	var ArtifactoryHttpClient = __webpack_require__(142).ArtifactoryHttpClient;

	var ArtifactoryStorage = __webpack_require__(143).ArtifactoryStorage;

	var ArtifactoryXmlParser = __webpack_require__(144).ArtifactoryXmlParser;

	var UserFactory = __webpack_require__(145).UserFactory;

	var ArtifactoryState = __webpack_require__(146).ArtifactoryState;

	var artifactorySessionInterceptor = __webpack_require__(147).artifactorySessionInterceptor;

	var artifactoryDebugInterceptor = __webpack_require__(148).artifactoryDebugInterceptor;

	var artifactorySpinnerInterceptor = __webpack_require__(149).artifactorySpinnerInterceptor;

	var artifactoryMessageInterceptor = __webpack_require__(150).artifactoryMessageInterceptor;

	var artifactoryServerErrorInterceptor = __webpack_require__(151).artifactoryServerErrorInterceptor;

	var ArtifactoryModelSaverFactory = __webpack_require__(152).ArtifactoryModelSaverFactory;

	var ArtifactoryFeatures = __webpack_require__(153).ArtifactoryFeatures;

	var GoogleAnalytics = __webpack_require__(154).GoogleAnalytics;

	var NativeBrowser = __webpack_require__(155).NativeBrowser;

	var ArtifactActions = __webpack_require__(156).ArtifactActions;

	var SetMeUpModal = __webpack_require__(159).SetMeUpModal;

	var ArtifactoryDeployModal = __webpack_require__(161).ArtifactoryDeployModal;

	var PushToBintrayModal = __webpack_require__(162).PushToBintrayModal;

	var parseUrl = __webpack_require__(163).parseUrl;

	var recursiveDirective = __webpack_require__(164).recursiveDirective;

	var ArtifactorySidebarDriver = __webpack_require__(165).ArtifactorySidebarDriver;

	var OnBoardingWizard = __webpack_require__(166).OnBoardingWizard;

	var SaveArtifactoryHaLicenses = __webpack_require__(167).SaveArtifactoryHaLicenses;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var ACTIONS = _interopRequire(__webpack_require__(157));

	var MESSAGES = _interopRequire(__webpack_require__(158));
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var SNIPPETS = _interopRequire(__webpack_require__(160));
	            ...
	            value: function show() {
	                ...
	                whenReady.then(function () {
	                    ...
	                    if (!quickSetup && !_this.initStatus.hasLicenseAlready && !_this.features.isAol() && !_this.features.isNonCommercial()) steps.push({
	                        ...
	                        id: "license",
	                        icon: "images/wizard-icons/icon_1_idle_gif.935.gif",
	                        iconSrcset: "images/wizard-icons/icon_1_idle_gif@2.935.gif 2x, images/wizard-icons/icon_1_idle_gif@3.935.gif 3x",
	                        buildIcon: "images/wizard-icons/icon_1_build_gif.935.gif",
	                        buildIconSrcset: "images/wizard-icons/icon_1_build_gif@2.935.gif 2x, images/wizard-icons/icon_1_build_gif@3.935.gif 3x",
	                    ...
	                    if (!quickSetup && !_this.user.isAdmin() && _this.initStatus.hasPriorLogins) steps.push({
	                        name: "Admin Login",
	                        id: "login",
	                        icon: "images/wizard-icons/icon_2_idle_gif.935.gif",
	                        iconSrcset: "images/wizard-icons/icon_2_idle_gif@2.935.gif 2x, images/wizard-icons/icon_2_idle_gif@3.935.gif 3x",
	                        buildIcon: "images/wizard-icons/icon_2_build_gif.935.gif",
	                        buildIconSrcset: "images/wizard-icons/icon_2_build_gif@2.935.gif 2x, images/wizard-icons/icon_2_build_gif@3.935.gif 3x",
	                    ...
	                    if (!quickSetup && !_this.features.isAol() && !_this.initStatus.hasProxies) steps.push({
	                        ...
	                        id: "proxy",
	                        icon: "images/wizard-icons/icon_3_idle_gif.935.gif",
	                        iconSrcset: "images/wizard-icons/icon_3_idle_gif@2.935.gif 2x, images/wizard-icons/icon_3_idle_gif@3.935.gif 3x",
	                        buildIcon: "images/wizard-icons/icon_3_build_gif.935.gif",
	                        buildIconSrcset: "images/wizard-icons/icon_3_build_gif@2.935.gif 2x, images/wizard-icons/icon_3_build_gif@3.935.gif 3x",
	                    ...
	                    steps.push({
	                        ...
	                        id: "packageTypes",
	                        icon: "images/wizard-icons/icon_4_idle_gif.935.gif",
	                        iconSrcset: "images/wizard-icons/icon_4_idle_gif@2.935.gif 2x, images/wizard-icons/icon_4_idle_gif@3.935.gif 3x",
	                        buildIcon: "images/wizard-icons/icon_4_build_gif.935.gif",
	                        buildIconSrcset: "images/wizard-icons/icon_4_build_gif@2.935.gif 2x, images/wizard-icons/icon_4_build_gif@3.935.gif 3x",
	                    ...
	                    steps.push({
	                        ...
	                        id: "summary",
	                        icon: "images/wizard-icons/icon_5_idle_gif.935.gif",
	                        iconSrcset: "images/wizard-icons/icon_5_idle_gif@2.935.gif 2x, images/wizard-icons/icon_5_idle_gif@3.935.gif 3x",
	                        buildIcon: "images/wizard-icons/icon_5_build_gif.935.gif",
	                        buildIconSrcset: "images/wizard-icons/icon_5_build_gif@2.935.gif 2x, images/wizard-icons/icon_5_build_gif@3.935.gif 3x",
